         ...
         <div className="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <button
              type="submit"
              disabled={isPending}
              className="w-full sm:w-auto cursor-pointer text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
            >
              {isPending ? <i className="fas fa-spin fa-spinner"></i> : "Login"}
            </button>
            <Link
              className="text-xl font-bold text-green-700 hover:text-green-800 text-center sm:text-left"
              to={"/forgetPassword"}
            >
              Forget Password?
            </Link>
